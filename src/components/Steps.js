        ...
        return (
            <div className="row form-steps pt-4">
                ...
                <div className={"col-lg-3 col-3 " + (this.props.step > 1 ? 'active' : '')}>
                    <i className="fas fa-baby" aria-hidden="true"></i><br/><small>Child Details</small></div>
                ...
                <div className={"col-lg-3 col-3 " + (this.props.step > 3 ? 'active' : '')}>
                    <i className="fas fa-check-circle" aria-hidden="true"></i><br/><small>Select Now</small></div>
            </div>
        )
    }
}
